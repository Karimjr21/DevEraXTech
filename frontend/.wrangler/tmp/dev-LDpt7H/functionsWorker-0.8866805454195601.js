...
// .wrangler/tmp/pages-gE4TIg/functionsWorker-0.8866805454195601.mjs
...
var portfolio_default = [
  { id: 1, title: "FinTech Dashboard", category: "Web App", image: "https://placehold.co/600x400?text=FinTech" },
  { id: 2, title: "E-Commerce Mobile", category: "Mobile", image: "https://placehold.co/600x400?text=E-Com" },
  { id: 3, title: "AI Analytics", category: "Data", image: "https://placehold.co/600x400?text=AI" }
];
async function onRequest3(context) {
  ...
  try {
    return new Response(JSON.stringify(portfolio_default), {
      status: 200,
      headers: {
        "Content-Type": "application/json",
        "Access-Control-Allow-Origin": env?.CORS_ORIGIN || "*"
...
__name2(sendWithResend, "sendWithResend");
...
__name(sendWithSendGrid, "sendWithSendGrid");
__name2(sendWithSendGrid, "sendWithSendGrid");
...
__name2(sendWithMailChannels, "sendWithMailChannels");
...
var testimonials_default = [
  { id: 1, author: "Startup CEO", quote: "DevEraX accelerated our product launch with stunning quality." },
  { id: 2, author: "CTO", quote: "Their security mindset saved us weeks of audit cycles." }
];
async function onRequest5(context) {
  ...
  try {
    return new Response(JSON.stringify(testimonials_default), {
      status: 200,
      headers: {
        "Content-Type": "application/json",
        "Access-Control-Allow-Origin": env?.CORS_ORIGIN || "*"
...
// C:/Users/karim/AppData/Roaming/npm/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// C:/Users/karim/AppData/Roaming/npm/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-9kmL7t/middleware-insertion-facade.js
...
// C:/Users/karim/AppData/Roaming/npm/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-9kmL7t/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.8866805454195601.js.map
